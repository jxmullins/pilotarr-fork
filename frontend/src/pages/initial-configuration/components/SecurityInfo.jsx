...
const SecurityInfo = () => {
  const securityFeatures = [
    ...
    },
    {
      ...
      description:
        "Connections use HTTPS/TLS protocols to prevent interception",
    },
    {
      icon: "Eye",
      title: "Privacy First",
    ...
    },
    {
      ...
      title: "Easy Updates",
      description:
        "Reconfigure services anytime without affecting existing data",
    },
  ];
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs md:text-sm text-foreground">
              <strong>Self-Hosted Security:</strong> This application runs
              entirely on your infrastructure. No data is transmitted to
              external servers, ensuring complete privacy and control over your
