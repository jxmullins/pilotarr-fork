...
import { getUsageAnalytics, getDeviceBreakdown, getMediaAnalytics, getServerMetrics } from '../../services/analyticsService';
  ...
  const fetchMediaAnalytics = async () => {
    ...
    try {
      ...
      const transformedData = data?.map(item => ({
        ...
        thumbnail: item?.poster_url || 'https://images.unsplash.com/photo-1574267432644-f610f5b7e4d1',
    ...
    const fetchServerMetrics = async () => {
      ...
      try {
        ...
        const transformedData = {
          ...
          transcodingSessions: data?.active_sessions?.map(session => ({
      ...
      <main className="pt-20 md:pt-24 px-4 md:px-6 lg:px-8 pb-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
            <ServerPerformancePanel performanceData={performanceData} isLoading={isLoadingPerformance} />
